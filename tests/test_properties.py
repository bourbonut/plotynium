from plotynium.properties import CanvasProperties, Properties, LegendProperties, Margin, DEFAULT_CANVAS_WIDTH, DEFAULT_LEGEND_WIDTH, DEFAULT_LEGEND_HEIGHT, DEFAULT_SQUARE_SIZE
...
def test_init_legend_properties(legend_properties):
    ...
    assert legend_properties.margin.top == (DEFAULT_LEGEND_HEIGHT - DEFAULT_SQUARE_SIZE // 2) // 2
    assert legend_properties.margin.left == DEFAULT_SQUARE_SIZE
    assert legend_properties.margin.bottom == (DEFAULT_LEGEND_HEIGHT - DEFAULT_SQUARE_SIZE // 2) // 2
