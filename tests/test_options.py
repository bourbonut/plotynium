from plotynium.options import ColorOptions, SymbolOptions, StyleOptions, SortOptions, XOptions, YOptions, init_options
...
def test_color_options_new():
    color_options = ColorOptions.new({"scheme": Interpolation.SINEBOW})
...
@pytest.mark.parametrize("class_", [ColorOptions, SymbolOptions, StyleOptions, SortOptions, XOptions, YOptions])
